...
I didn't cover corner cases like when name is missing or something. It's very straightforward and basic(and time consuming) to add validations like this to this test.
